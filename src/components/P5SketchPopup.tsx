// Temporarily disabled due to react-p5 dependency removal
// "use client";
...
//     } else {
//       imgs.current[1] = p5.loadImage("/test1.png");
//       imgs.current[2] = p5.loadImage("/test2.png");
//       imgs.current[3] = p5.loadImage("/test3.png");
//     }
//   };
...
export default function P5SketchPopup() {
  return null;
}
